...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('stylecalendar.css')}}">
...
<div class="container-fluid py-5">
    <div class="container py-5">
        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
            <h1 class="display-6 mb-3">JOURS DE SERVICES</h1>
            <p class="mb-5"></p>
        </div>
        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                <p class="mb-4">Cher(e) patient(e),

Je tiens à vous informer de mes heures de disponibilité pour les consultations médicales. Mon objectif est de vous fournir des soins de qualité tout en respectant votre emploi du temps. Voici mes horaires de consultation. <a
                        href="https://htmlcodex.com/contact-form"></a>.</p>


                        Lundi : de [Heure de début] à [Heure de fin]
Mardi : de [Heure de début] à [Heure de fin]
Mercredi : de [Heure de début] à [Heure de fin]
Jeudi : de [Heure de début] à [Heure de fin]
Vendredi : de [Heure de début] à [Heure de fin]
                <!-- <form>
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                ...
                                <label for="email">Disponibilite</label>
                            </div>
                        </div> -->
                        <!-- <div class="col-12">
                            <div class="form-floating">
             ...
             <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                <iframe class="w-100 h-100"
                    src="images\etudes-infirmieres-ifsi-macsf-615x555.jpg"
