        ...
        <div class="container pb-2">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex">
                    ...
                    <div class="ms-3">
                        <h5 class="text-white mb-0">Appellez maintenant</h5>
                        <span>+226 01020304</span>
                    </div>
                </div>
                ...
                <div class="d-flex">
                    ...
                    <div class="ms-3">
                        <h5 class="text-white mb-0">Envoyer un email</h5>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-lg-0 px-lg-3">
                <a href="index.html" class="navbar-brand d-lg-none">
                    <h1 class="text-primary m-0">San<span class="text-dark">TE</span></h1>
                </a>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="images\agent-sante-coup-moyen-equipement.jpg" alt="Image">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="images\assurance-complementaire-sante.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="row g-0">
                        <div class="col-6">
                            <img class="img-fluid" src="images\labo1.jpg">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid" src="images\labo4.jpg">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid" src="images\labo2.webp">
                        </div>
                        <div class="col-6">
    ...
    <div class="container-fluid container-service py-5">
        <div class="container pt-5">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h1 class="display-6 mb-3">Nos specialités</h1>
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">Test de pathologie</h4>
        ...
        <div class="container pb-5">
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="images\istockphoto-919539202-1024x1024.jpg" alt="">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="images\infirmiere-aide-humanitaire-afrique-se-prepare-pour-travail.jpg" alt="">
                            <div class="team-social">
                                <a class="btn btn-square btn-light mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square btn-light mx-1" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square btn-light mx-1" href=""><i class="fab fa-linkedin-in"></i></a>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="images\22198037-portrait-de-jeune-infirmière-africaine-debout-dans-le-bureau-moderne.jpg" alt="">
                            <div class="team-social">
                                <a class="btn btn-square btn-light mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square btn-light mx-1" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square btn-light mx-1" href=""><i class="fab fa-linkedin-in"></i></a>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="images\istockphoto-477537475-612x612.jpg" alt="">
                            <div class="team-social">
                                <a class="btn btn-square btn-light mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square btn-light mx-1" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square btn-light mx-1" href=""><i class="fab fa-linkedin-in"></i></a>
...
<div class="container-fluid py-5">
    <div class="container py-5">
        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
            <h1 class="display-6 mb-3"> Prenez rendez-vous</h1>
            <p class="mb-5"></p>
        </div>
            ...
            <div class="col-lg-6">
                <a href="tel:+0123456789" class="d-flex justify-content-lg-center bg-primary p-4">
                    ...
                    <div class="ms-3">
                        ...
                        <h2 class="text-white mb-0">226 345 67890</h2>
                    </div>
                </a>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row g-5">
            <div class=" offset-3 col-6 col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <form>
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <button class="btn btn-primary py-3 px-5" type="submit">Envoyer votre Message</button>
                        </div>
                    </div>
                </form>
            </div>
