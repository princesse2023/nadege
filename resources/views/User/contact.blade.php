        ...
        <div class="container pb-2">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex">
                    ...
                    <div class="ms-3">
                        <h5 class="text-white mb-0">appeler maintenant</h5>
                        <span>226 01010101</span>
                    </div>
                </div>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h1 class="display-6 mb-3"> Contactez-nous</h1>
            ...
            <div class="row contact-info position-relative g-0 mb-5">
                <div class="col-lg-6">
                    <a href="tel:+0123456789" class="d-flex justify-content-lg-center bg-primary p-4">
                        ...
                        <div class="ms-3">
                            <h5 class="text-white">conatactez-nous</h5>
                            <h2 class="text-white mb-0">2260020202</h2>
                        </div>
                    </a>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container">
            <div class="row g-5 py-5">
                <div class="col-lg-6 pe-lg-5">
                    ...
                    <p><i class="fa fa-map-marker-alt me-2"></i>123 rue, KDG, BF</p>
                    <p><i class="fa fa-phone-alt me-2"></i>226 345 67890</p>
                ...
                <div class="col-lg-6 ps-lg-5">
                    <div class="row g-5">
                        ...
                        <div class="col-sm-6">
                            <h4 class="text-light mb-4">Autes Liens</h4>
                            <a class="btn btn-link" href="">About Us</a>
                            <a class="btn btn-link" href="">Contact Us</a>
                            <a class="btn btn-link" href="">Our Services</a>
                            <a class="btn btn-link" href="">Terms & Condition</a>
