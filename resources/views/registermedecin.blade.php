        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              ...
              <form action="{{route('inscriptmedecinTraitement')}}" method="POST">
                  @csrf
                ...
                <div class="form-outline mb-4">
                <select class="form-select" aria-label="Default select example" name="specialite_id"  required>
                @foreach($specialites as $specialite)
                         <option selected></option>
                          <!-- <option value="{{ $specialite->nom }}"></option> -->
                        <option value="{{ $specialite->id }}">{{ $specialite->nom }}</option> 
                        <!-- <option value="3">Three</option>  -->
                        @endforeach
                          </select>
                         <label class="form-label" for="form3Example1cg">specialite</label>
                </div>
